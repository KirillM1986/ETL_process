/* Для таблиц-источников витрины rd.product и rd.deal_info отсутствует выгрузка 
по датам эффективности effective_from_date. Для витрины rd.product отсутствуют строки за даты 2023-01-01 и 2023-08-11.
Для витрины rd.deal_info отсутствуют строки за дату 2023-03-15. 
Источник, из которого были загружены данные сущности на слой rd, 
предоставил актуальные выгрузки имеющихся у них данных в формате csv. 
В файле deal_info.csv предоставлены данные  за дату 2023-03-15 - потребуется загрузка данных без перезагрузки таблицы.
